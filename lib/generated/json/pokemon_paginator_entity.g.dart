...
PokemonPaginatorEntity $PokemonPaginatorEntityFromJson(Map<String, dynamic> json) {
	final PokemonPaginatorEntity pokemonPaginatorEntity = PokemonPaginatorEntity();
	...
	final List<PokemonPaginatorResults>? results = jsonConvert.convertListNotNull<PokemonPaginatorResults>(json['results']);
	if (results != null) {
...
Map<String, dynamic> $PokemonPaginatorEntityToJson(PokemonPaginatorEntity entity) {
...
PokemonPaginatorResults $PokemonPaginatorResultsFromJson(Map<String, dynamic> json) {
	final PokemonPaginatorResults pokemonPaginatorResults = PokemonPaginatorResults();
...
Map<String, dynamic> $PokemonPaginatorResultsToJson(PokemonPaginatorResults entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
