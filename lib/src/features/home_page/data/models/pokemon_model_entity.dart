...
class PokemonModelEntity {
  ...
  factory PokemonModelEntity.fromJson(Map<String, dynamic> json) => $PokemonModelEntityFromJson(json);
...
class PokemonModelTypes {
  ...
  factory PokemonModelTypes.fromJson(Map<String, dynamic> json) => $PokemonModelTypesFromJson(json);
...
class PokemonModelTypesType {
  ...
  factory PokemonModelTypesType.fromJson(Map<String, dynamic> json) => $PokemonModelTypesTypeFromJson(json);
